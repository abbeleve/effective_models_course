...
class CNN(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=32, kernel_size=7, stride=2, bias=False)
        ...
        self.conv3 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, stride=2, bias=False)
        self.conv4 = nn.Conv2d(in_channels=128, out_chanels=256, kernel_size=1, bias=False)
        self.conv5 = nn.Conv2d(in_channels=256, out_chanels=256, kernel_size=3, stride=2, bias=False)
